...
class TestIterPublicFigures:
    ...
    def test_iter_single_page(self, wikidata_client):
        ...
        with patch.object(wikidata_client, 'get_public_figures', return_value=(mock_results, "direct")):
    ...
    def test_iter_custom_page_size(self, wikidata_client):
        ...
        with patch.object(wikidata_client, 'get_public_figures', return_value=(mock_results, "direct")) as mock:
    ...
    def test_iter_with_filters(self, wikidata_client):
        ...
        with patch.object(wikidata_client, 'get_public_figures', return_value=(mock_results, "direct")) as mock:
            list(wikidata_client.iter_public_figures(
...
class TestIterPublicInstitutions:
    ...
    def test_iter_single_page(self, wikidata_client):
        ...
        with patch.object(wikidata_client, 'get_public_institutions', return_value=(mock_results, "direct")):
    ...
    def test_iter_multiple_pages(self, wikidata_client):
        ...
        with patch.object(wikidata_client, 'get_public_institutions', side_effect=mock_get_institutions):
            results = list(wikidata_client.iter_public_institutions(country="Q30"))
    ...
    def test_iter_custom_page_size(self, wikidata_client):
        ...
        with patch.object(wikidata_client, 'get_public_institutions', return_value=(mock_results, "direct")) as mock:
    ...
    def test_iter_with_filters(self, wikidata_client):
        ...
        with patch.object(wikidata_client, 'get_public_institutions', return_value=(mock_results, "direct")) as mock:
            list(wikidata_client.iter_public_institutions(
                country="Q30",
                type=["Q327333"],
                jurisdiction="Q30"
            ))
